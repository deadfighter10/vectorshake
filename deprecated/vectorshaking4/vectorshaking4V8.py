...
os.environ["CUBLAS_WORKSPACE_CONFIG"] = ":4096:8"  # Enable deterministic CuBLAS behavior
...
# Enable deterministic algorithms in PyTorch (note that this may slow down training)
...
# Build mapping from unique labels (across train and test) to integers.
...
train_texts_sample, _, train_labels_sample, _ = train_test_split(
    train_texts_all, train_labels_all, test_size=0.01, random_state=42,
...
# ------------------------------------------------------------------------------
# 4. FGSM Adversarial Perturbation Function (applied to the [CLS] token)
# ------------------------------------------------------------------------------
