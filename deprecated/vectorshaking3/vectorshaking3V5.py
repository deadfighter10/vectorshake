...
# ------------------------------
# 2. Load GoEmotions Dataset (Simplified)
# ------------------------------
...
# ------------------------------
# 3. Baseline Model Training Function
# ------------------------------
...
# ------------------------------
# 5. Improved Training Function with Consistency & Reconstruction Loss
# ------------------------------
def train_improved_multi(model, data_loader, optimizer, device, current_epoch, total_epochs,
                           lambda_consistency=0.7, lambda_recon=0.5, base_epsilon=0.01, num_variations=10):
    model.train()
    total_loss = 0.0
    total_orig_loss = 0.0
    total_adv_loss = 0.0
    ...
    for batch in data_loader:
        ...
        for _ in range(num_variations):
            ...
            # Reconstruction loss: Compare reconstruction of perturbed latent to original latent
...
def main():
    ...
    # Update num_labels to 28 for 28 classes
    ...
    ########################
    # Experiment B: Improved Model (with Latent Perturbation, Consistency & Reconstruction Loss)
    ########################
    ...
    # Hyperparameters: We set λ_consistency = 0.7, λ_recon = 0.5, base_epsilon = 0.01, num_variations = 10
